...
-- 3/07/2019
-- v1.4.3
-- 1.4.3 changes: image folder name changed to /GUIframe from /imgs
...
GUIframe.defaults = {
    ...
    resizeHeight = 30,
    resizeWidth = 30,
    resizeHoverImage = "/GUIframe-1.0/blue_arrows.png",
    resizeRestImage = "/GUIframe-1.0/blue_arrows_30t.png",
    borderOffset = 5,
}
